...
public class Studentmenu extends JFrame {
	...
	public Studentmenu() {
        ...
        JButton classrecbutton = new JButton("Class Record");
        classrecbutton.setFont(new Font("Tahoma", Font.BOLD, 20));
        classrecbutton.setBounds(650, 225, 211, 85);
        panel.add(classrecbutton);
        
        JButton editclassbutton = new JButton("Edit Attendance");
        editclassbutton.setFont(new Font("Tahoma", Font.BOLD, 20));
        editclassbutton.setBounds(397, 225, 211, 85);
