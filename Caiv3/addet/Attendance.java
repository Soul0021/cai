...
public class Attendance extends JFrame {
    ...
    public Attendance() {
        ...
        btnabsent.setFont(new Font("Tahoma", Font.BOLD, 15));
        btnabsent.setBounds(293, 34, 101, 27);
        panel.add(btnabsent);

        JButton PresentButton = new JButton("Present");
        PresentButton.setFont(new Font("Tahoma", Font.BOLD, 15));
        // Set the button's position and size: x, y, width, height
        PresentButton.setBounds(182, 34, 101, 27); // For example, width=150, height=40
